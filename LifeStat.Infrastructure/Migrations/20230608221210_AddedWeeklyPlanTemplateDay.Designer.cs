...
namespace LifeStat.Infrastructure.Migrations
{
    ...
    [Migration("20230608221210_AddedWeeklyPlanTemplateDay")]
    partial class AddedWeeklyPlanTemplateDay
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LifeStat.Infrastructure.Persistence.Models.WeeklyPlanTemplateDayDL", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WeeklyPlanTemplateDays");
                });
            ...
            modelBuilder.Entity("LifeStat.Infrastructure.Persistence.Models.WeeklyPlanTemplateDayDL", b =>
                {
                    b.HasOne("LifeStat.Infrastructure.Persistence.Models.DailyPlanTemplateDL", "DailyPlanTemplate")
                        .WithMany("WeeklyPlanTemplateDays")
                        .HasForeignKey("DailyPlanTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LifeStat.Infrastructure.Persistence.Models.DailyPlanTemplateDL", b =>
                {
                    ...
                    b.Navigation("WeeklyPlanTemplateDays");
                });
